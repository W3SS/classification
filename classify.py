...
if __name__ == "__main__":
    ...
    if sys.argv[2] == "door":
        ...
        #with open("DoorsTrainData.txt", 'w') as tr, open("DoorsTestData.txt", 'w') as te:
        #    json.dump(trainData,tr)
        #    json.dump(testData,te)
        print "Retrieving featurized door data..."
        trainData = json.load(open("./data/doors/DoorsTrainData.txt",'r'))
        testData = json.load(open("./data/doors/DoorsTestData.txt",'r'))
    ...
    elif sys.argv[2] == "emailFull":
        emailTrainFileLoc = "./data/train_small.txt"
        emailTestFileLoc = "/course/cs141/assignments/projects/classification/2015/data/test.txt"
        print "Featurizing emailFull data..."
        ...
        if sys.argv[1] == "naive":
            ...
            emailTrainFileLoc = "./data/train.txt"
            emailTestFileLoc = "/course/cs141/assignments/projects/classification/2015/data/test_full.txt"
            maxWords = 100
            downSamplingRate = 1
